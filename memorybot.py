...
st.set_page_config(page_title=' ChatGPT4u with Memory ', layout='wide', page_icon = im)
...
st.write("我提供此应用初衷的让国内的人也可以体验使用增加了记忆的ChatGPT。我在为你的每次使用支付调用OpenAI API的费用，目前入不敷出，请每次使用扫码微信支付¥1人民币以便我能够一直提供这个AI小程序，谢谢！")
